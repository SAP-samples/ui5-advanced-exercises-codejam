...
import ODataContextBinding, { ODataContextBinding$ChangeEvent } from "sap/ui/model/odata/v4/ODataContextBinding";
...
export default class Main extends Controller {
	...
	public onFlyToProduct(event: Button$PressEvent): void {
		...
		supermarket.setCameraPosition(JSON.parse(position))
	}
}
